      ...
      <div className="relative overflow-hidden border border-white/5 bg-[#0f1f2a] text-white shadow-[0_24px_70px_rgba(15,31,42,.12)]">
        ...
        <div className="relative grid md:grid-cols-[1.15fr_.85fr]">
          <div className="p-8 md:p-12 lg:p-16">
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-white/70">{message}</p>
            <div className="mt-8 flex flex-wrap gap-3">
              <a href={whatsappHref()} target="_blank" rel="noreferrer" className="btn btn-light">Ask on WhatsApp</a>
              <a href={phoneHref} className="btn btn-outline-light">Call {business.phone}</a>
            </div>
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-2 text-[11px] font-bold uppercase tracking-[0.12em] text-white/42">
          ...
          <div className="relative min-h-72 border-t border-white/10 md:min-h-full md:border-l md:border-t-0" aria-hidden="true">
            <div className="material-board absolute inset-8 shadow-[0_24px_60px_rgba(0,0,0,.18)] md:inset-10" />
            <div className="absolute bottom-5 right-5 border border-white/15 bg-[#0f1f2a]/92 px-4 py-3 text-right backdrop-blur md:bottom-8 md:right-8">
